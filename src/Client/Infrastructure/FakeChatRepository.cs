...
namespace VirtualReception.Client.Infrastructure
{
    public class FakeChatRepository : IChatRepository
    {
        ...
        {
            var messageTime = System.DateTime.Now;
            ...
            chat.CreateMessage(member_2.Id, "Wie können wir behilflich sein?");
            chat.CreateMessage(member_1.Id, "Ich möchte mich zu meiner Buchung informieren");
            chat.CreateMessage(member_2.Id, "Können Sie mit bitte Ihre Buchungsnummer zukommen lassen?");
